    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 md:px-16 lg:px-24 xl:px-32'>
      <div>
        <div className='flex flex-col items-start text-left'>
          ...
          <p className='text-sm md:text-base text-gray-500/90 mt-2'>If you are a Ironhack Teacher, You will receive 7 Free Nights</p>
        </div>
        ...
        {roomsDummyData.map((room)=> (
          <div className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last-pb-30 last:border-0' key={room._id}>
            ...
            src={room.images[0]} alt="room-image" title='View details' className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer'/>
